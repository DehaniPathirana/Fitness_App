...
const RegistrationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Make a POST request to the endpoint with user data
          ...
          <div className="container">
            <div className="card border-light-subtle shadow-sm">
              <div className="row g-0">
                <div className="register-card col-12 col-md-6 text-bg">
                  ...
                  <div className="card-body p-3 p-md-4 p-xl-5">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="row gy-3 gy-md-4 overflow-hidden">
                        ...
                        {/* Add similar input fields for last name, email, and password */}
                        <div className="col-12">
                    ...
                    <div className="row">
                      <div className="col-12">
                        ...
                        <div className="d-flex gap-3 flex-column flex-xl-row">
                          <a href="#!" className="btn-google bsb-btn-xl btn-outline-primary" onClick={handleGoogleLogin}>
                            <svg
                            ...
                            <span className="head ms-2 fs-6">Google</span>
                          </a>
